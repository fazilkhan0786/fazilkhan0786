...
ROWS = [
    ("host",),
    ("kv", "Now", "Open to opportunities!"),
    ("kv", "Prev", "Founder & CEO @ Promacle"),
    ("kv", "Also", "Intern @ MiroFish Uk"),
    ("kv", "Edu", "B.E CE, Sal College Of Engineering"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Frontend", "React, Next.js, TypeScript, Redux, Tailwind"),
    ("kv", "Backend", "Node.js, Express.js, MongoDB, SQL"),
    ("kv", "Languages", "JavaScript, TypeScript, Python, C++, Java"),
    ("kv", "Tools", "Git, Docker, Postman, Vercel, Netlify"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Passionate about building Startups, AI/ML's and Problem solving projects"),
    ("bul", "Experienced in Everything you want"),
]
